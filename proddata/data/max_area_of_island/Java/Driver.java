package max_area_of_island.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/max_area_of_island/testcases.txt";
    ...
    {
        return new max_area_of_island.Java.Solution().maxAreaOfIsland(nums);
    }
}