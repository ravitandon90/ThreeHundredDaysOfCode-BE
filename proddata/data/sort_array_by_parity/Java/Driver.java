package sort_array_by_parity.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/sort_array_by_parity/testcases.txt";
    ...
    public static int[] user(int[] nums) {
        sort_array_by_parity.Java.Solution sol = new sort_array_by_parity.Java.Solution();
        return sol.sortArrayByParity(nums);
    }
