...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/sort_an_array/testcases.txt";
    ...
    public static int[] user(int[] nums) {
        sort_an_array.Java.Solution sol = new sort_an_array.Java.Solution();
        return sol.sortArray(nums);
