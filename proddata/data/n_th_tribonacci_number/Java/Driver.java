package n_th_tribonacci_number.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/n_th_tribonacci_number/testcases.txt";
    ...
    public static int user(int n) {
        return new n_th_tribonacci_number.Java.Solution().tribonacci(n);
    }
}