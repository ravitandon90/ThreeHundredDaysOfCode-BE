package maximum_units_on_a_truck.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/maximum_units_on_a_truck/testcases.txt";
        ...
        for (int i = 0; i < al.size(); i++) {
            if (i % 2 == 0) {
                ...
                int user_out = user(points,extraStudents);

                b = b & out==user_out;
                if (b == false) {
                    System.out.println("Test case");
                    System.out.println("boxType = "+ Arrays.deepToString(points));
                    System.out.println("truckSize = "+extraStudents);
    ...
    {
        return new maximum_units_on_a_truck.Java.Solution().maximumUnits(nums, n);
    }
}