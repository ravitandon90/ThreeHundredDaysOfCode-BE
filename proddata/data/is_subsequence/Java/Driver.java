...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/is_subsequence/testcases.txt";
    ...
    public static boolean user(String s, String t) {
        return new is_subsequence.Java.Solution().isSubsequence(s, t);
    }
}