package find_minimum_in_rotated_sorted_array.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/find_minimum_in_rotated_sorted_array/testcases.txt";
    ...
    public static int user(int[] nums) {
        find_minimum_in_rotated_sorted_array.Java.Solution sol = new find_minimum_in_rotated_sorted_array.Java.Solution();
