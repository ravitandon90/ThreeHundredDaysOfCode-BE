package network_delay_time.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/network_delay_time/testcases.txt";
        ...
        for (int i = 0; i < al.size(); i++) {
            if (i % 2 == 0) {
                ...
                int user_out = user(points,n,m);
                b = b & out == user_out;
                if (b == false) {
                    System.out.println("Test case");
                    System.out.println("times = "+ Arrays.deepToString(points));
    ...
    public static int user(int nums[][], int n, int m)
    {
        return new network_delay_time.Java.Solution().networkDelayTime(nums, n, m);
    }
}