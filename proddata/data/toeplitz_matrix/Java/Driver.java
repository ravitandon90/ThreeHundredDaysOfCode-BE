...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/toeplitz_matrix/testcases.txt";
    ...
    public static boolean user(int matrix[][])
    {
        return new toeplitz_matrix.Java.Solution().isToeplitzMatrix(matrix);
    }
}