...
public class Driver
{
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/island_perimeter/testcases.txt";
        ...
        for (int i = 0; i< al.size();i++)
        {
            ...
            else if(al.get(i).equals("check"))
            {
                ...
                if (b == false) {
                    ...
                    System.out.println("grid = "+Arrays.deepToString(input1));
    ...
    public static int subsets(int input[][]) {
        return new island_perimeter.Java.Solution().islandPerimeter(input);
    }
}
