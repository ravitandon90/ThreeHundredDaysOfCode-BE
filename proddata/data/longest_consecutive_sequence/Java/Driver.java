package longest_consecutive_sequence.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/longest_consecutive_sequence/testcases.txt";
    ...
    public static int user(int[] nums) {
        longest_consecutive_sequence.Java.Solution sol = new longest_consecutive_sequence.Java.Solution();
