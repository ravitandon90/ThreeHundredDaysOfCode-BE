package non_overlapping_intervals.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/non_overlapping_intervals/testcases.txt";
    ...
    {
        return new non_overlapping_intervals.Java.Solution().eraseOverlapIntervals(nums);
    }
}