...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/monotonic_array/testcases.txt";
    ...
    public static boolean user(int[] nums) {
        monotonic_array.Java.Solution sol = new monotonic_array.Java.Solution();
        return sol.isMonotonic(nums);
    }
