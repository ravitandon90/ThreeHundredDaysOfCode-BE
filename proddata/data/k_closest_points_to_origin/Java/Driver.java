package k_closest_points_to_origin.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/k_closest_points_to_origin/testcases.txt";
    ...
    {
        return new k_closest_points_to_origin.Java.Solution().kClosest(nums, n);
    }
}