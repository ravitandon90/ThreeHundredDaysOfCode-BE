package reorder_routes_to_make_all_paths_lead_to_the_city_zero.Java;
...
public class Driver {
    ...
    static boolean drivercode() {
        String filePath = "proddata/data/reorder_routes_to_make_all_paths_lead_to_the_city_zero/testcases.txt";
        ...
        for (int i = 0; i < al.size(); i++) {
            if (i % 2 == 0) {
                ...
                int user_out = user(n,points);
                b = b & out == user_out;
                if (b == false) {
                    System.out.println("Test case");
                    System.out.println("n = "+n);
                    System.out.println("connections = "+ Arrays.deepToString(points));
    ...
    public static int user(int n,int nums[][])
    {
        return new reorder_routes_to_make_all_paths_lead_to_the_city_zero.Java.Solution().minReorder(n,nums);
    }
}